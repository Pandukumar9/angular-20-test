...
import { ProjectCanvas } from './project-canvas/project-canvas';
import { Benguluru } from './benguluru/benguluru';
...
//     // { path: 'vizard', component: VizardDashboard},
//   // { path: 'account', loadComponent: () => import('./account/account').then(m => m.Account) },
//   // { path: 'chat', loadComponent: () => import('./chat/chat').then(m => m.Chat) },
// ];
export const routes: Routes = [
  { path: '', redirectTo: 'clients', pathMatch: 'full' }, // optional
  { path: 'clients', component: ClientDashboard },
  { path: 'clients/:id/projects', component: ProjectDashboard },
  { path: 'clients/:id/projects/:projectId/canvas', component: ProjectCanvas },
  { path: 'clients/:id/vizard', component: VizardDashboard  },
  { path: 'benguluru', component: Benguluru  },
];
